...
ERROR_TYPES_DB: Dict[str, ErrorType] = {
    "FileNotFoundError": ErrorType(
        ...
        suggestion=(
            "Check if file path exists. " "Use os.path.exists() for pre-check."
        ),
        auto_fixable=False,
    ),
    ...
    "ModuleNotFoundError": ErrorType(
        ...
        severity=ErrorSeverity.ERROR,
        suggestion=(
            "Check if module is installed. " "Try: pip install <module-name>"
        ),
    ...
    "ConnectionError": ErrorType(
        ...
        severity=ErrorSeverity.ERROR,
        suggestion=(
            "Check network connection status. " "Verify endpoint availability."
        ),
        auto_fixable=False,
    ),
...
def get_category_errors(category: ErrorCategory) -> list:
    ...
    return [
        name
        for name, error_type in ERROR_TYPES_DB.items()
