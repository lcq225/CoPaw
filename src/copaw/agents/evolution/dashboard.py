...
class EvolutionDashboard:
    ...
    def _generate_summary(self) -> Dict[str, Any]:
        ...
        total_improvements = sum(
            m.improvements_applied for m in self.metrics_history
        )
    ...
    def _generate_markdown(self, report: Dict[str, Any]) -> str:
        ...
        md.append(
            f"- **Total Errors Captured:** {summary.get('total_captured', 0)}",
        )
        md.append(
            f"- **Patterns Detected:** {summary.get('total_patterns', 0)}",
        )
        md.append(
